...
class SmoothLyricsReader extends StatefulWidget {
  final Size? size;
  ...
  @override
  State<SmoothLyricsReader> createState() => _SmoothLyricsReaderState();
}

class _SmoothLyricsReaderState extends State<SmoothLyricsReader>
  ...
  @override
  void didUpdateWidget(covariant SmoothLyricsReader oldWidget) {
  ...
  void animationOffset(double offset) {
    ...
    ).chain(CurveTween(curve: Curves.easeOutCubic)).animate(_lineController!)
